import { getDOM } from "./chunk-TZGWHDQY.js";
import {
    ChangeDetectorRef,
    Directive,
    ElementRef,
    ...
    static ɵfac = /* @__PURE__ */ (() => {
        ...
        return function BuiltInControlValueAccessor_Factory(__ngFactoryType__) {
            return (
                ...
                (ɵBuiltInControlValueAccessor_BaseFactory =
                    ɵɵgetInheritedFactory(_BuiltInControlValueAccessor))
...
var CheckboxControlValueAccessor = class _CheckboxControlValueAccessor extends BuiltInControlValueAccessor {
    ...
    static ɵfac = /* @__PURE__ */ (() => {
        ...
        return function CheckboxControlValueAccessor_Factory(
            __ngFactoryType__
        ) {
            return (
                ɵCheckboxControlValueAccessor_BaseFactory ||
                (ɵCheckboxControlValueAccessor_BaseFactory =
                    ɵɵgetInheritedFactory(_CheckboxControlValueAccessor))
    ...
    static ɵdir = ɵɵdefineDirective({
        ...
        hostBindings: function DefaultValueAccessor_HostBindings(rf, ctx) {
            if (rf & 1) {
                ɵɵlistener(
                    "input",
                    function DefaultValueAccessor_input_HostBindingHandler(
                        $event
                    ) {
                    ...
                    "blur",
                    function DefaultValueAccessor_blur_HostBindingHandler() {
                        return ctx.onTouched();
                    }
                )(
                    "compositionstart",
...
var AbstractControl = class {
    ...
    markAsPending(opts = {}) {
        ...
        if (opts.emitEvent !== false) {
            this._events.next(
                new StatusChangeEvent(this.status, sourceControl)
            );
...
function validateFormGroupControls(controls) {
    const invalidKeys = Object.keys(controls).filter((key) =>
        key.includes(".")
    );
    ...
    static ɵfac = /* @__PURE__ */ (() => {
        ...
        return function AbstractFormGroupDirective_Factory(__ngFactoryType__) {
            return (
                ...
                (ɵAbstractFormGroupDirective_BaseFactory =
                    ɵɵgetInheritedFactory(_AbstractFormGroupDirective))
    ...
    static ɵdir = ɵɵdefineDirective({
        ...
        hostBindings: function NumberValueAccessor_HostBindings(rf, ctx) {
            if (rf & 1) {
                ɵɵlistener(
                    "input",
                    function NumberValueAccessor_input_HostBindingHandler(
                        $event
                    ) {
                    ...
                    "blur",
                    function NumberValueAccessor_blur_HostBindingHandler() {
                        return ctx.onTouched();
                    }
                );
            }
...
var RadioControlValueAccessor = class _RadioControlValueAccessor extends BuiltInControlValueAccessor {
    ...
    static ɵfac = function RadioControlValueAccessor_Factory(
        __ngFactoryType__
    ) {
    ...
    static ɵdir = ɵɵdefineDirective({
        ...
        hostBindings: function RangeValueAccessor_HostBindings(rf, ctx) {
            if (rf & 1) {
                ɵɵlistener(
                    "change",
                    function RangeValueAccessor_change_HostBindingHandler(
                        $event
                    ) {
                        return ctx.onChange($event.target.value);
                    }
                    ...
                    "input",
                    function RangeValueAccessor_input_HostBindingHandler(
                        $event
                    ) {
                        return ctx.onChange($event.target.value);
                    }
                    ...
                    "blur",
                    function RangeValueAccessor_blur_HostBindingHandler() {
                        return ctx.onTouched();
                    }
                );
            }
    ...
    static ɵdir = ɵɵdefineDirective({
        ...
        hostBindings: function FormGroupDirective_HostBindings(rf, ctx) {
            if (rf & 1) {
                ɵɵlistener(
                    "submit",
                    function FormGroupDirective_submit_HostBindingHandler(
                        $event
                    ) {
                        return ctx.onSubmit($event);
                    }
                    ...
                    "reset",
                    function FormGroupDirective_reset_HostBindingHandler() {
                        return ctx.onReset();
                    }
                );
            }
...
var SelectControlValueAccessor = class _SelectControlValueAccessor extends BuiltInControlValueAccessor {
    ...
    static ɵfac = /* @__PURE__ */ (() => {
        ...
        return function SelectControlValueAccessor_Factory(__ngFactoryType__) {
            return (
                ...
                (ɵSelectControlValueAccessor_BaseFactory =
                    ɵɵgetInheritedFactory(_SelectControlValueAccessor))
    ...
    static ɵdir = ɵɵdefineDirective({
        ...
        hostBindings: function SelectControlValueAccessor_HostBindings(
            rf,
            ctx
        ) {
            if (rf & 1) {
...
var AbstractValidatorDirective = class _AbstractValidatorDirective {
    ...
    static ɵfac = function AbstractValidatorDirective_Factory(
        __ngFactoryType__
    ) {
    ...
    static ɵfac = /* @__PURE__ */ (() => {
        ...
        return function MaxValidator_Factory(__ngFactoryType__) {
            return (
                ...
                (ɵMaxValidator_BaseFactory =
                    ɵɵgetInheritedFactory(_MaxValidator))
    ...
    static ɵfac = /* @__PURE__ */ (() => {
        ...
        return function MinValidator_Factory(__ngFactoryType__) {
            return (
                ...
                (ɵMinValidator_BaseFactory =
                    ɵɵgetInheritedFactory(_MinValidator))
...
var ɵInternalFormsSharedModule = class _ɵInternalFormsSharedModule {
    static ɵfac = function ɵInternalFormsSharedModule_Factory(
        __ngFactoryType__
    ) {
