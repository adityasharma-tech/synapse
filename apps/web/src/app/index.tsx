            ...
            <main>
                ...
                >
                    <div className="h-full">
                        <div className="text-6xl flex flex-col gap-y-4">
                            ...
                            <span>
                                and{" "}
                                <span style={{ color: "#DD7373" }}>secure</span>
                            </span>
                        ...
                        <div className="py-10">
                            <p className="max-w-sm">
                                Chat effortlessly, connect globally, share
                                ideas, build communities, and grow together.
                            </p>
                        </div>
                ...
                <div className="w-full py-36 flex justify-center gap-x-14 items-center bg-neutral-100 dark:bg-[#222]">
                    ...
                    <div className="max-w-xl text-sm text-neutral-600">
                        ...
                        elit. Unde molestias tempore voluptatem, deserunt
                        debitis doloribus porro placeat nesciunt obcaecati cum
                        reiciendis maiores et explicabo culpa repellendus? Iure
                        pariatur soluta doloremque, fugiat praesentium aut atque
                        qui, reprehenderit optio minima quis! Distinctio!
                    </div>
                </div>
            </main>
        </div>
