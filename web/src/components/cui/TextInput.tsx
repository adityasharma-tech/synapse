...
export default function TextInput({ className, contentClassName, label, ...props }: { className?: string; contentClassName?: string; label: string; } & React.InputHTMLAttributes<HTMLInputElement>) {
  return (
