...
const colorClasses = {
  emerald: "from-emerald-700 to-emerald-900 hover:from-emerald-600 ring-emerald-800",
  neutral: "from-neutral-800 to-neutral-900 hover:from-neutral-700 ring-neutral-800",
}
