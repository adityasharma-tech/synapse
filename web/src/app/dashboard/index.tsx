...
export default function DashboardPage() {
  ...
  const handleCreateStream: MouseEventHandler<HTMLButtonElement> = useCallback(
    async (e) => {
      e.preventDefault();
        ...
        <div className="flex gap-x-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 bg-neutral-100">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => navigate("/user/logout")}>
                Log out
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        ...
        <div className="min-w-sm min-h-12 bg-neutral-900 rounded-lg p-3">
          ...
          <div className="flex items-center gap-x-2 rounded-lg py-1 bg-[#222] my-3">
            <div className="flex items-center gap-x-2 px-3">
              <div>
                <img src="https://youtube.com/favicon.ico" className="" />
              </div>
            ...
            <div className="flex-grow mr-1 rounded-md bg-neutral-900 px-2 focus-within:border-neutral-600 border border-transparent">
              <input
                ref={videoInputRef}
                onChange={(e) =>
                  debouncer(handleFetchVideoData.bind(null, e), 1000)
                }
                ...
                <div className="flex gap-x-3">
                  <div>
                    <img
                      ...
                      src={str.thumbnailUrl ?? "https://placehold.co/150x80"}
                    />
                  </div>
                  <div className="flex flex-col justify-center gap-y-1">
                    <div className="font-medium">{str.streamTitle}</div>
                    {str.videoUrl ? (
